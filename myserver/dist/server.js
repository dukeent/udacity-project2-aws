...
(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    app.get('/filteredimage', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (!image_url) {
            ...
            try {
                // Call filterImageFromURL(image_url) to filter the img
                const filteredImageURL = yield (0, util_1.filterImageFromURL)(image_url);
                ...
                res.status(200).sendFile(filteredImageURL, (err) => {
                    if (err) {
                        ...
                        (0, util_1.deleteLocalFiles)([filteredImageURL]);
                    }
                });
            }
            catch (error) {
